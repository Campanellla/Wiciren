...
export class _pipe extends Construction {
	...
	constructor(args){
		...
		let left =   {location: {x:0, z:0}, size: this.itemSize, conlocation: {x:-1, z:0}, itemPointer: this.pointer};
		let top =    {location: {x:0, z:0}, size: this.itemSize, conlocation: {x:0, z:1} , itemPointer: this.pointer};
		let right =  {location: {x:0, z:0}, size: this.itemSize, conlocation: {x:1, z:0} , itemPointer: this.pointer};
		let bottom = {location: {x:0, z:0}, size: this.itemSize, conlocation: {x:0, z:-1}, itemPointer: this.pointer};
		let connectionsArgs;
		switch(this.subtype){
			case "3-way": connectionsArgs = [left, 		right,	bottom]; break;
			case "4-way": connectionsArgs = [left, top,	right,	bottom]; break;
			case "angle": connectionsArgs = [left, 				bottom]; break;
			default     : connectionsArgs = [left, 		right		  ]; break;
		};
		let modelargs = {
